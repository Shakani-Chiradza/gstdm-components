        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-10 w-[90%] mx-auto text-gray-600">
                <div>
                    ...
                    <Link href="/desires/canoeing" className="hover:opacity-50">
                ...
                <div>
                    ...
                    <Link href="/desires/hiking" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
                <div>
                    ...
                    <Link href="/desires/honeymoon" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
                <div>
                    ...
                    <Link href="/desires/hot-air" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
                <div>
                    ...
                    <Link href="/desires/safari" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
                <div>
                    ...
                    <Link href="/desires/spa" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
                ...
                <div>
                    ...
                    <Link href="/desires/water" className="hover:opacity-50">
                        <p className="mt-3 text-lg font-semibold">See more</p>
                        <hr className="w-[22%] h-1 bg-gray-600 boarder-0 rounded mb-5"/>
                    </Link>
                </div>
