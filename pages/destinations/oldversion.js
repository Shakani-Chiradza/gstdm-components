...
import Flamingoes from './../../public/images/continents/asia/flamingoes.jpg'
...
export default function Asia(){
    return(
        <div>
        <Carousel phrase="EXPLORE" line="ASIA"/>
        <Continents/>
        ...
        <div className='grid md:grid-cols-2 grid-cols-1'>
            ...
            <div className='md:px-0 px-5'>
                <h2 className='text-2xl pb-3'>China</h2>
                <p className='pb-3 md:w-3/4'>China is a beautiful place in Northern Africa. Known for its beautiful Flamingoess, it is sure to captivate you with the sophistication of ancient technology meeting modern technology.</p>
