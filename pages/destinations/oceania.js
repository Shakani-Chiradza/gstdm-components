...
import Hut from './../../public/images/continents/oceania/hut.jpg'
    ...
    return(
        ...
        <div className='grid md:grid-cols-2 grid-cols-1'>
            ...
            <div className='md:px-0 px-5'>
                <h2 className='text-2xl pb-3'>AUSTRALIA</h2>
                <p className='pb-3 md:w-3/4'>AUSTRALIA is a beautiful place in Northern Africa. Known for its beautiful Huts, it is sure to captivate you with the sophistication of ancient technology meeting modern technology.</p>
